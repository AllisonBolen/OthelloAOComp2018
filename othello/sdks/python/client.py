...
def nexToPlayer(member, row, col, board):
    ...
    if(row is not 7):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((rowCopy+1 < 8) and board[rowCopy+1][col] is not 0 and not boolFoundMe):
            rowCopy = rowCopy + 1
            enemyCount = enemyCount + 1
    ...
    if(col is not 0):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy-1 > -1) and board[row][colCopy-1] is not 0 and not boolFoundMe):
            colCopy = colCopy - 1
            enemyCount = enemyCount + 1
    ...
    if(col is not 7):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy+1 < 8) and board[row][colCopy+1] is not 0 and not boolFoundMe):
            colCopy = colCopy + 1
            enemyCount = enemyCount + 1
            if(board[row][colCopy] is  member):
                boolFoundMe = True
    ...
    if(row is not 0 and col is not 0):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy -1 > -1) and (rowCopy-1 > -1) and board[rowCopy-1][colCopy-1] is not 0 and not boolFoundMe):
            colCopy = colCopy - 1
            rowCopy = rowCopy - 1
            enemyCount = enemyCount + 1
    ...
    if(row is not 7 and col is not 0):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy-1 > -1) and (rowCopy+1 < 8) and board[rowCopy+1][colCopy-1] is not 0 and not boolFoundMe):
            colCopy = colCopy - 1
            rowCopy = rowCopy + 1
            enemyCount = enemyCount + 1
            if(board[rowCopy][colCopy] is  member):
    ...
    if(row is not 0 and col is not 7):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy+1 < 8) and (rowCopy-1 > -1) and board[rowCopy-1][colCopy+1] is not 0 and not boolFoundMe):
            colCopy = colCopy + 1
            rowCopy = rowCopy - 1
            enemyCount = enemyCount + 1
            if(board[rowCopy][colCopy] is  member):
    ...
    if(row is not 7 and col is not 7):
        ...
        enemyCount = 0
        boolFoundMe = False
        while((colCopy+1 < 8) and (rowCopy+1 < 8) and board[rowCopy+1][colCopy+1] is not 0 and not boolFoundMe):
            colCopy = colCopy + 1
            rowCopy = rowCopy + 1
            enemyCount = enemyCount + 1
            if(board[rowCopy][colCopy] is  member):
